...
## 💡 Solución propuesta
**Justino** busca simplificar el acceso a la normativa mediante un agente conversacional que:
- Explica requisitos de forma clara y accesible.  
...
## 🌍 Escalabilidad
Aunque actualmente el enfoque está en **México ↔ USA**, el proyecto es **escalable a decenas de países** para los cuales SENASICA emite certificados de importación y exportación de mascotas vía aérea.
